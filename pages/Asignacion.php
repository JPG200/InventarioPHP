						...
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">
									<button class="btn btn-sm btn-success" data-target="#createAsignacion" data-toggle="modal" aria-expanded="false" aria-controls="createAsignacion">
										Asignar</button>
								</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<div class="table-responsive">
										<table id="Tabla_Asignacion" class="table table-bordered table-sm">
											<thead>
												<tr>
...
<script src="../assets/js/Asignacion.js" type="text/javascript"></script>
